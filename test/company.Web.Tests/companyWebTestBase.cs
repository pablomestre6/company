...
{
    public abstract class companyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static companyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(companyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<companyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<companyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<companyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<companyDbContext, Task<T>> func)
        {
            T result;
